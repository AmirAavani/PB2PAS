...
const (
	...
	GreeterService_ListHellos_FullMethodName = "/greeter.GreeterService/ListHellos"
)
...
type GreeterServiceClient interface {
	// A standard (unary) RPC: client sends one request, server sends one response.
	SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error)
	// A server-streaming RPC: client sends one request, server sends multiple responses.
	ListHellos(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error)
}
...
func (c *greeterServiceClient) ListHellos(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, GreeterService_ListHellos_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServiceServer interface {
	...
	// A server-streaming RPC: client sends one request, server sends multiple responses.
	ListHellos(context.Context, *HelloRequest) (*HelloReply, error)
...
func (UnimplementedGreeterServiceServer) ListHellos(context.Context, *HelloRequest) (*HelloReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ListHellos not implemented")
}
...
func _GreeterService_ListHellos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServiceServer).ListHellos(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GreeterService_ListHellos_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServiceServer).ListHellos(ctx, req.(*HelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GreeterService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _GreeterService_ListHellos_Handler,
		},
	},
