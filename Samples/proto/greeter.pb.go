...
const file_proto_greeter_proto_rawDesc = "" +
	...
	"\bSayHello\x12\x15.greeter.HelloRequest\x1a\x13.greeter.HelloReply\x128\n" +
	"\n" +
	"ListHellos\x12\x15.greeter.HelloRequest\x1a\x13.greeter.HelloReplyB\"Z github.com/example/greeter/protob\x06proto3"
...
var file_proto_greeter_proto_depIdxs = []int32{
	...
	0, // 1: greeter.GreeterService.ListHellos:input_type -> greeter.HelloRequest
	1, // 2: greeter.GreeterService.SayHello:output_type -> greeter.HelloReply
	1, // 3: greeter.GreeterService.ListHellos:output_type -> greeter.HelloReply
