...
type
  ...
  public
    class function GetParser(InputStream: TStream): TBaseProtoParser;
...
class function TBaseProtoParser.GetParser(InputStream: TStream): TBaseProtoParser;
var
...
begin
  ...
  Result := TProto3.Create('3', Imports, Packages, Options, Messages, Enums);
